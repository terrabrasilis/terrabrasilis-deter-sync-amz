...
JSON_RESPONSE=$(curl -s "$GEOSERVER_BASE_URL/$GEOSERVER_BASE_PATH?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&TYPENAME=$PROJECT_NAME:$LAYER_NAME&OUTPUTFORMAT=application%2Fjson")
